...
async function whatsAsena () {
    ...
    conn.on('connecting', async () => {
        console.log(`${chalk.green.bold('Toxic')}${chalk.blue.bold('Mol')}
${chalk.white.italic('coded by rizad[Toxic Coder]')}
...
${chalk.blue.italic('ℹ️  Connecting to Whatsapp... Please Wait.')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('coded by rizad[Toxic Coder]'), Session.createStringSession(conn.base64EncodedAuthInfo())
        );
