    ...
    Asena.addCommand({pattern: 'isong ?(.*)', fromMe: false, desc: Lang.ISONG_DESC}, (async (message, match) => { 
        ...
        ffmpeg(stream)
            ...
            .on('end', async () => {
                ...
                await message.client.sendMessage(message.jid,Buffer.from(writer.arrayBuffer), MessageType.audio, {filename: 'ᴍᴀᴅᴇ ʙʏ ᴛᴏxɪᴄ ᴍᴡᴏʟ' + '.mp3', mimetype: 'audio/mpeg', quoted: message.data});
            });
    }));
